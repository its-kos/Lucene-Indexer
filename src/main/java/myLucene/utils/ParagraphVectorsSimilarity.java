...
public class ParagraphVectorsSimilarity extends Similarity {
  ...
  private class PVSimScorer extends SimScorer {
    ...
    public String toString() {
        return "PVSimScore{" + "weight=" + weight + ", context=" + context + ", fieldTerms=" + fieldTerms + ", reader=" + reader + '}';
    }
  ...
  private class PVSimWeight extends SimWeight {
    ...
    @Override
    public String toString() {
        return "EmbeddingsSimWeight{" + "boost=" + boost + ", collectionStats=" + collectionStats + ", termStats=" + Arrays.toString(termStats) + '}';
    }
  }
}